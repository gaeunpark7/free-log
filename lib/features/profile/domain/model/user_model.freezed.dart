...
class _UserModel implements UserModel {
   _UserModel({required this.id, required this.email, this.nickname, @JsonKey(name: 'hourly_rate') this.hourlyRate = 0, @JsonKey(name: 'margin_rate') this.marginRate = 0.3, @JsonKey(name: 'notify_deadline') this.notifyDeadline = true, @JsonKey(name: 'created_at') this.createdAt});
