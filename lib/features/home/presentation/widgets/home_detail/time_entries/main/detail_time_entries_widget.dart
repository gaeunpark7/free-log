                          ...
                          data: (entries) {
                            ...
                            return Row(
                              children: [
                                ...
                                SizedBox(width: 10),
                                Text('${total}h', style: AppTextStyles.subTitle(context).copyWith(color: Colors.grey)),
                              ],
                            );
                          },
                        ) ??
              ...
              if (_isAdding) ...[
                ...
                AppFilledButton(
                  onPressed: () async {
                    ...
                    await ref.read(timeEntryNotifierProvider(widget.projectId).notifier).addTimeEntry(_selectedDate, double.tryParse(_hoursController.text.replaceAll('h', '')) ?? 0);
