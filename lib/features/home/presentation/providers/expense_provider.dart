...
final expenseRepoProvider = Provider<ExpenseRepository>((ref) => ExpenseRepositoryImpl(ref.watch(supabaseClientProvider)));
final expenseNotifierProvider = AsyncNotifierProviderFamily<ExpenseProvider, List<ExpenseModel>, String>(ExpenseProvider.new);
